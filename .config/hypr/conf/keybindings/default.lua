...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("~/.config/ml4w/settings/filemanager.sh"), { description = "Open filemanager" })
...
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("hyprctl activewindow | grep pid | tr -d 'pid:' | xargs kill"), { description = "Kill all instances" })
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ mode = "fullscreen", action = "toggle" }), { description = "Fullscreen" })
hl.bind(mainMod .. " + M", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }), { description = "Maximize" })
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant-copy-area"))
hl.bind(mainMod .. " + ALT + F", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant"))
hl.bind(mainMod .. " + ALT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant-area"))
hl.bind(mainMod .. " + ALT + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/text-extractor.sh"))
...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + CTRL + " .. key,
        hl.dsp.exec_cmd("~/.config/hypr/scripts/moveTo.sh " .. i),
...
-- hl.bind("XF86Lock", hl.dsp.exec_cmd("hyprlock"), { locked = true })
hl.bind("XF86Tools", hl.dsp.exec_cmd("flatpak run com.ml4w.settings"), { locked = true })

hl.bind("code:238", hl.dsp.exec_cmd("brightnessctl -d smc::kbd_backlight s +10"), { locked = true })
hl.bind("code:237", hl.dsp.exec_cmd("brightnessctl -d smc::kbd_backlight s 10-"), { locked = true })



-- =====================================================
-- Additional ML4W Features (Conflict-Free)
-- =====================================================
...
hl.bind(
    mainMod .. " + O",
    hl.dsp.exec_cmd(
        "qs -p ~/.config/quickshell/overview ipc call overview toggle"
    ),
...
hl.bind(
    mainMod .. " + ALT + X",
    hl.dsp.exec_cmd(
        "~/.config/ml4w/scripts/ml4w-toggle-scratchpad-window"
    ),
    { description = "Scratchpad Toggle" }
)
