...
-- hl.bind(mainMod .. " + SHIFT + G", hl.dsp.group.active("f"), { description = "Switch to next group window" }) // error
...
-- not working for some reason, needs fixing
...
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant"), { description = "Take an instant full-screen screenshot" })
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant-copy-area"), { description = "Take an instant area screenshot" })
...
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/ml4w/themes/themes.sh"), { description = "Open Select Theme Window Menu" })

-- Example special workspace (scratchpad)
hl.bind(mainMod .. " + ALT + F", hl.dsp.workspace.toggle_special("magic"), { description = "Toggle special workspace magic" })
